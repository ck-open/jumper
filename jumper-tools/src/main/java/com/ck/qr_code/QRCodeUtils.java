...
import com.ck.qr_code.swetake.util.Qrcode;
...
public class QRCodeUtils {
    ...
    public static String decoderQRCode(String imgPath) {
        ...
        try {
            ...
            return new String(decoder.decode(new TwoDimensionCodeImage(bufImg)), StandardCharsets.UTF_8);
